...
OBJ_DEBUG = $(OBJDIR_DEBUG)/main.o $(OBJDIR_DEBUG)/image_processing/findPatterns.o $(OBJDIR_DEBUG)/image_processing/histograms.o $(OBJDIR_DEBUG)/image_processing/imageComparison.o $(OBJDIR_DEBUG)/image_processing/imageResizer.o $(OBJDIR_DEBUG)/tools/parameter_parser.o $(OBJDIR_DEBUG)/tools/string_extension_scanner.o $(OBJDIR_DEBUG)/tools/timers.o $(OBJDIR_DEBUG)/codecs/pngInput.o $(OBJDIR_DEBUG)/caching/resultbank.o $(OBJDIR_DEBUG)/codecs/codecs.o $(OBJDIR_DEBUG)/codecs/jpgExifexternal.o $(OBJDIR_DEBUG)/codecs/jpgInput.o $(OBJDIR_DEBUG)/codecs/ppmInput.o $(OBJDIR_DEBUG)/image_processing/faceDetection.o $(OBJDIR_DEBUG)/image_processing/filters.o

OBJ_RELEASE = $(OBJDIR_RELEASE)/main.o $(OBJDIR_RELEASE)/image_processing/findPatterns.o $(OBJDIR_RELEASE)/image_processing/histograms.o $(OBJDIR_RELEASE)/image_processing/imageComparison.o $(OBJDIR_RELEASE)/image_processing/imageResizer.o $(OBJDIR_RELEASE)/tools/parameter_parser.o $(OBJDIR_RELEASE)/tools/string_extension_scanner.o $(OBJDIR_RELEASE)/tools/timers.o $(OBJDIR_RELEASE)/codecs/pngInput.o $(OBJDIR_RELEASE)/caching/resultbank.o $(OBJDIR_RELEASE)/codecs/codecs.o $(OBJDIR_RELEASE)/codecs/jpgExifexternal.o $(OBJDIR_RELEASE)/codecs/jpgInput.o $(OBJDIR_RELEASE)/codecs/ppmInput.o $(OBJDIR_RELEASE)/image_processing/faceDetection.o $(OBJDIR_RELEASE)/image_processing/filters.o
...
before_debug: 
	...
	test -d $(OBJDIR_DEBUG)/caching || mkdir -p $(OBJDIR_DEBUG)/caching
...
$(OBJDIR_DEBUG)/image_processing/findPatterns.o: image_processing/findPatterns.c
	$(CC) $(CFLAGS_DEBUG) $(INC_DEBUG) -c image_processing/findPatterns.c -o $(OBJDIR_DEBUG)/image_processing/findPatterns.o
...
$(OBJDIR_DEBUG)/caching/resultbank.o: caching/resultbank.c
	$(CC) $(CFLAGS_DEBUG) $(INC_DEBUG) -c caching/resultbank.c -o $(OBJDIR_DEBUG)/caching/resultbank.o
...
before_release: 
	...
	test -d $(OBJDIR_RELEASE)/caching || mkdir -p $(OBJDIR_RELEASE)/caching
...
$(OBJDIR_RELEASE)/image_processing/findPatterns.o: image_processing/findPatterns.c
	$(CC) $(CFLAGS_RELEASE) $(INC_RELEASE) -c image_processing/findPatterns.c -o $(OBJDIR_RELEASE)/image_processing/findPatterns.o
...
$(OBJDIR_RELEASE)/caching/resultbank.o: caching/resultbank.c
	$(CC) $(CFLAGS_RELEASE) $(INC_RELEASE) -c caching/resultbank.c -o $(OBJDIR_RELEASE)/caching/resultbank.o
