...
OBJ_DEBUG = $(OBJDIR_DEBUG)/tools/timers.o $(OBJDIR_DEBUG)/tools/string_extension_scanner.o $(OBJDIR_DEBUG)/tools/parameter_parser.o $(OBJDIR_DEBUG)/main.o $(OBJDIR_DEBUG)/image_processing/imageResizer.o $(OBJDIR_DEBUG)/image_processing/imageComparison.o $(OBJDIR_DEBUG)/image_processing/histograms.o $(OBJDIR_DEBUG)/image_processing/findObjectsSURF.o $(OBJDIR_DEBUG)/image_processing/faceDetection.o $(OBJDIR_DEBUG)/codecs/ppmInput.o $(OBJDIR_DEBUG)/codecs/pngInput.o $(OBJDIR_DEBUG)/codecs/jpgInput.o $(OBJDIR_DEBUG)/codecs/jpgExifexternal.o $(OBJDIR_DEBUG)/codecs/codecs.o

OBJ_RELEASE = $(OBJDIR_RELEASE)/tools/timers.o $(OBJDIR_RELEASE)/tools/string_extension_scanner.o $(OBJDIR_RELEASE)/tools/parameter_parser.o $(OBJDIR_RELEASE)/main.o $(OBJDIR_RELEASE)/image_processing/imageResizer.o $(OBJDIR_RELEASE)/image_processing/imageComparison.o $(OBJDIR_RELEASE)/image_processing/histograms.o $(OBJDIR_RELEASE)/image_processing/findObjectsSURF.o $(OBJDIR_RELEASE)/image_processing/faceDetection.o $(OBJDIR_RELEASE)/codecs/ppmInput.o $(OBJDIR_RELEASE)/codecs/pngInput.o $(OBJDIR_RELEASE)/codecs/jpgInput.o $(OBJDIR_RELEASE)/codecs/jpgExifexternal.o $(OBJDIR_RELEASE)/codecs/codecs.o
