...
OBJ_DEBUG = $(OBJDIR_DEBUG)/tools/string_extension_scanner.o $(OBJDIR_DEBUG)/tools/parameter_parser.o $(OBJDIR_DEBUG)/main.o $(OBJDIR_DEBUG)/image_processing/imageResizer.o $(OBJDIR_DEBUG)/image_processing/histograms.o $(OBJDIR_DEBUG)/codecs/ppm.o $(OBJDIR_DEBUG)/codecs/jpg.o $(OBJDIR_DEBUG)/codecs/codecs.o

OBJ_RELEASE = $(OBJDIR_RELEASE)/tools/string_extension_scanner.o $(OBJDIR_RELEASE)/tools/parameter_parser.o $(OBJDIR_RELEASE)/main.o $(OBJDIR_RELEASE)/image_processing/imageResizer.o $(OBJDIR_RELEASE)/image_processing/histograms.o $(OBJDIR_RELEASE)/codecs/ppm.o $(OBJDIR_RELEASE)/codecs/jpg.o $(OBJDIR_RELEASE)/codecs/codecs.o
